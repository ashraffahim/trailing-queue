...
/**
 * RolePermissionsController implements the CRUD actions for RolePermission model.
 */
class RolePermissionsController extends _MainController
{
    /**
     * @inheritDoc
     */
    ...
    {
        if (($model = RolePermission::findOne(['id' => $id])) !== null) {
            return $model;
        }
