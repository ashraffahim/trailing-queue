...
window.tokenRoles.forEach(role => {
    ...
    const button = $('<button class="btn-classic sm:max-w-xl w-full text-4xl uppercase py-6 m-0 generate-token"></button>');
    ...
    button.on('click', async () => {
        ...
        sendPrintRequest([
            ...
            { size: 12.0, text: responseData.date + ' ' + responseData.date },
